...
HubIntegration::HubIntegration(UDSUtil* udsUtil, HubCache* hubCache) : HubAccount(udsUtil, hubCache) {
    ...
    _description = "";
    _serverName = "";
    _iconFilename = "images/hub_icon.png";
    _lockedIconFilename = "images/hub_icon.png";
    _composeIconFilename = "images/hub_icon.png";
    _supportsCompose = false;
    _supportsMarkRead = true;
    _supportsMarkUnread = true;
    _headlessTarget = "com.kartun.VKChatHeadlessService";
    _appTarget = "com.kartun.VKChat";
    _cardTarget = "com.kartun.VKChat.card";
    _itemMimeType = "hub/vnd.imVK.item";  // mime type for hub items - if you change this, adjust invocation targets
