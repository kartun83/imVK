       ...
       // QString auth_url = "https://oauth.vk.com/authorize?client_id=&redirect_uri=https://oauth.vk.com/blank.html&scope=friends,messages&display=mobile";
        ...
        public:
            typedef enum {
                ...
                _request_getWall            = 17,
//                _request_verify     = 9,
//                _request_reannounce = 10,
//                _resuest_delete     = 11,
//                _request_torrentInfo = 12,
            } requestType;
            typedef enum  {
                _lps_request_init = 1,
                _lps_request_poll = 2,
    ...
    Q_SIGNALS:
        ...
        void networkLPSReceived(const QByteArray &buffer);
    public Q_SLOTS:
...
//        void onNewMessageReceived(vk_api::new_message_struct newMessage);
    public:
        ...
        void setNewToken(QString& accessToken);
        ...
        void vk_send_message(int userID, QString messageText);
